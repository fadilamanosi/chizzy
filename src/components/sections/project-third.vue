    ...
    <div class="grid gap-36">
            ...
            <div class="grid text-start gap-8">
                <div class="grid text-start">
                    ...
                    <p class="text-[24px] lg:w-[90%]">
                        ...
                        proof-of-stake staking (PoS) that locks fund in the protocol, stakers receive liquid staking
                        derivatives in exchange for their staked assets.
                    </p>
                </div>
            ...
            <div class="grid text-start gap-8">
                <div class="grid text-start gap-4 lg:w-[90%]">
                    ...
                    <p class="text-[24px] ">
                        ...
                        decentralization. It is a liquid staking solution that solves the problem of locked liquidity by
                        providing instant liquidity for staked assets. It lowers the staking barrier by allowing stakers
                        stake any amount of ETH.
                    </p>

                    <p class="text-[24px]">
                        The aim of Stakify is to make staking on ethereum accessible. It allows stakers delegate any amount
                        of ETH token to a staking pool and start earning rewards on them.
                    </p>
                    <p class="text-[24px]">
                        Stakers will receive a token sETH which represents their staked ETH. The staked ETH can be used as
                        collateral in DeFi applications to accrue more rewards.n. It is a liquid staking solution that
                        solves the problem of locked liquidity by providing instant liquidity for staked assets. It lowers
                        the staking barrier by allowing stakers stake any amount of ETH.
                    </p>
                </div>
            </div>
                    ...
                    <div class="text-[24px] grid gap-11">
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                with pooling functionality like Stakify was built to address this problem by allowing users
                                stake any amount of ETH which is then pooled together with the stake of other users to
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                requires some technical knowhow.
                            </p>
                        </div>
            ...
            <div class="grid text-start gap-8">
                <div class="grid text-start gap-4 lg:w-[90%]">
                    ...
                    <p class="text-[24px] ">
                        ...
                        get a token that represents a claim on their staked ETH. They can make use of the staked ETH as
                        collateral in DeFi applications to boost their yield.
                    </p>
            ...
            <div class="grid text-start gap-8">
                <div class="grid text-start gap-4 lg:w-[90%]">
                    ...
                    <div class="text-[24px] grid gap-6 ">
                        <p>
                            I was the only designer on this project, this gave me full control on the look and feel on the
                            brand. I worked on the brand identity design so I chose the colours and the typeface, this made
                            it
                            easy to achieve coherence with the brand identity and the UI design. I went for cool colours and
                            an
                            interface that was both welcoming and aesthetically pleasing.
                        </p>
                        <p>
                            I worked on both the web application and the landing page.
                        </p>
                    </div>
        ...
        <section class="grid gap-40 lg:px-[8em] md:px-[4em] px-4">
            ...
            <div class="grid gap-6">
                ...
                <p class="text-[24px]">
                    Designing stakify was a challenging and interesting project. It taught me a lot about liquid staking
                ...
                <div class="grid gap-6">
                    ...
                    <div class="grid text-[24px] lg:w-[60%] list-disc">
                        ...
                        <li>
                            Pooled staking is one of the best things that’s happening in DeFi, It shows the importance of
                            continuous innovations and how it can impact the entire ecosystem.
                            better.
                        </li>
                        <li>
                            We should all contribute our own quota in building a decentralized internet, it is not the job
                            of a few, it is for everyone.
                        </li>
                    </div>
                </div>
